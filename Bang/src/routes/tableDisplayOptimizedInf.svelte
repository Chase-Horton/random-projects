<script lang="ts">
    ...
    class discoids {
      ...
      constructor(startMemIndex:number, startOpIndex:number, memDial:number[], rotateMemAmt:number, rotateOpAmt:number){
        this.opDial = [this.increment, this.push, this.outputStack, this.startWhile, this.sumAB, this.outputTop, this.endWhile, this.shift, this.decrement, this.forget, this.clr, this.inputStack, this.pop];
